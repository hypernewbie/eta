...
function peerDisplayName(peer) {
    ...
    if (peer.name)
        name = peer.name;
    else if (peer.ssh_destination)
        name = peer.ssh_destination;
    else {
        try {
...
function renderWidgetCalendar(now) {
